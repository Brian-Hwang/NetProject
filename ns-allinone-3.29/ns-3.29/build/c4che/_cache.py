...
EXAMPLE_DIRECTORIES = ['tutorial', 'stats', 'ipv6', 'routing', 'socket', 'tcp', 'wireless', 'naming', 'traffic-control', 'udp', 'matrix-topology', 'realtime', 'udp-client-server', 'error-model', 'energy']
